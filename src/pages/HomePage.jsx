          ...
          <div class="max-w-2xl text-center mx-auto">
            ...
            <div class="mt-5 max-w-3xl">
              <p class="text-lg text-gray-600">
                ...
                Commodi, maxime perferendis laudantium incidunt non nihil natus
                quaerat odit delectus.
              </p>
            </div>
            ...
            <div class="mt-8 gap-3 flex justify-center">
              ...
              <a
                class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                href="#"
              >
                <svg
                  class="shrink-0 size-4"
